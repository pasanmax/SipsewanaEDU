...
<head>
  ...
  <title>Director | Student Payment Report</title>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-open">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../Registration/Report.php" class="nav-link">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">View Student Payment Report</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form id="stuPayReport" action="../../../../models/director.php" method="POST">
                <div class="form-group">
                  <label for="studentid">Student ID</label>
                  <input type="text" id="studentid" name="studentid" placeholder="Student ID" class="form-control" required>
                </div>
                <div class="card-footer">
                  <button type="submit" name="SubStuPayRegReport" class="btn btn-info">Submit</button>
