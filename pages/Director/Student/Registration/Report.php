...
<head>
  ...
  <title>Director | Student Registration Report</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">View Student Registration Report</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form id="stuRegReport" action="../../../../models/director.php" method="POST">
                ...
                <div class="card-footer">
                  <button type="submit" name="SubStuRegReport" class="btn btn-info">Submit</button>
