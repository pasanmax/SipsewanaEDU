...
<head>
  ...
  <title>Director | Lecturer Registration Report</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Lecturer Registration Report</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../Dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Lecturer</li>
              <li class="breadcrumb-item active">View Lecturer Registration Report</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form id="lecRegReport" action="../../../../models/director.php" method="POST">
                ...
                <div class="card-footer">
                  <button type="submit" name="SubLecRegReport" class="btn btn-info">Submit</button>
