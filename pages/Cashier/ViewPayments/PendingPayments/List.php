      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-open">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="../AllPayments/List.php" class="nav-link">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Manage Pending Payments</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            <div class="card-body">
              <table id="paymentList" class="table table-bordered table-striped">
                ...
                <?php
                  $list = $cashier->getPendingPayment($_SESSION['id']);
                ?>
                <thead>
                <tr>
                  <th>Payment ID</th>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group btn-group-sm">
                      ...
                      <a href="../../../../models/cashier.php?delPay=<?= $item['pay_id']?>" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i></a>
                    </div>
                  </td>
                </tr>
                <?php }}?>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="updatePayment" action="../../../../models/cashier.php" method="POST">
                    <table width="500px" height="300px">
                      <tr hidden>
                        <div class="form-group">
                          <td><label for="paymentid">Payment ID : </label></td>
                          <td><input type="text" id="paymentid" name="paymentid" required></td>
                        </div>
                      </tr>
                      <tr>
                        <div class="form-group">
                      ...
                      <tr>
                        <div class="form-group">
                          ...
                          <td>
                            <input id="subject" name="subject" readonly>
                          </td>
                        </div>
                      </tr>
                      <tr>
                        <div class="form-group">
                          ...
                          <td><input name="amount" id="amount" readonly></td>
                        </div>
                      </tr>
                      <tr>
                        <div class="form-group">
                    ...
                    <div class="modal-footer justify-content-between">
                      <button type="submit" name="updatePayment" class="btn btn-info">Update</button>
...
<script>
  ...
  $('.editClass').on('click', function() {
    ...
    document.getElementById('paymentid').value = data[0];
