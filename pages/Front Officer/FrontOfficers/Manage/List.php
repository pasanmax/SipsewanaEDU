...
<head>
  ...
  <title>Front Officer | Front Officer List</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Front Officer List</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../Dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Front Officers</li>
              <li class="breadcrumb-item active">Manage Front Officers</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <?php $list = $frontofficer->getFoOfficerList();?>
              <table id="frontOfficerList" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>Front Officer ID</th>
                  <th>First Name</th>
                  <th>Last Name</th>
                  <th>Email</th>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group btn-group-sm">
                      ...
                      <?php if($_SESSION['id'] !== $item['fo_id']){?>
                      <a href="../../../../models/frontofficer.php?delFo=<?= $item['fo_id']?>" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i></a>
                      <?php }?>
                    </div>
                  </td>
                </tr>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Update Front Officer</h4>
                ...
                <div class="modal-body">
                  <form id="updateFOfficer" action="../../../../models/frontofficer.php" method="POST">
                    <table width="500px" height="300px">
                      <tr hidden>
                        <div class="form-group">
                          <td><label for="foid">Front Officer ID : </label></td>
                          <td><input type="text" id="foid" name="foid" required></td>
                        </div>
                      </tr>
                      <tr>
                        <div class="form-group">
                          <td><label for="fofname">First Name : </label></td>
                          <td>
                            <input id="fofname" name="fofname" required>
                          </td>
                        </div>
                      </tr>
                      <tr>
                        <div class="form-group">
                          <td><label for="folname">Last Name : </label></td>
                          <td>
                            <input id="folname" name="folname" required>
                          </td>
                        </div>
                      </tr>
                      <tr>
                    ...
                    <div class="modal-footer justify-content-between">
                      <button type="submit" name="updateFoOfficer" class="btn btn-info">Update</button>
...
<script>
  $(function () {
    $("#frontOfficerList").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false
    }).buttons().container().appendTo('#frontOfficerList_wrapper .col-md-6:eq(0)');
  });
  ...
  $('.editClass').on('click', function() {
    ...
    document.getElementById('foid').value = data[0];
    document.getElementById('fofname').value = data[1];
    document.getElementById('folname').value = data[2];
