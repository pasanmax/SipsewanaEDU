...
<head>
  ...
  <title>Front Officer | Offline Attendance List</title>
          ...
          <div class="col-sm-6">
            ...
            <form id="searchStudent" action="../../../../models/stu_attendance.php" method="POST">
              <div class="row mt-4">
                ...
                <div class="col-md-4">
                  <button type="submit" name="stOfAttenSearch" class="btn btn-block btn-primary text-left">Search</button>
                </div>
              </div>
            </form>
          </div>
