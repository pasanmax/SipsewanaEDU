...
<head>
  ...
  <title>Front Officer | Online Attendance List</title>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <form id="searchStudent" action="../../../../models/stu_attendance.php" method="POST">
              <div class="row mt-4">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                  <button type="submit" name="stOnAttenSearch" class="btn btn-block btn-primary text-left">Search</button>
                </div>
              </div>
            </form>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">View Online Attendance</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
