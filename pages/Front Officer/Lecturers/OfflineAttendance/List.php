          ...
          <div class="col-sm-6">
            ...
            <form id="searchStudent" action="../../../../models/lec_attendance.php" method="POST">
              <div class="row mt-4">
                ...
                <div class="col-md-4">
                  <button type="submit" name="lecOfAttenSearch" class="btn btn-block btn-primary text-left">Search</button>
                </div>
              </div>
            </form>
          </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <?php
              if(isset($_SESSION['lec_Of_att_id'])) {
                include "$_SERVER[DOCUMENT_ROOT]/SipsewanaEDU/models/lec_attendance.php";
                $lecAttendance = new Lec_Attendance();
                $list = $lecAttendance->getLecturerOfflineAttendance($_SESSION['lec_Of_att_id']);
              } else {
                $list = null;
              }
              ?>
