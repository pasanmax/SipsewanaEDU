...
<head>
  ...
  <title>Front Officer | Paid Payment List</title>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <form id="searchclass" action="../../../../models/cashier.php" method="POST">
              <div class="row mt-4">
                <div class="col-md-4">
                  <div class="form-group">
                      <input type="text" id="cashierid" name="cashierid" placeholder="Cashier ID" style="width: 100%;">
                    </div>
                  </div>
                <div class="col-md-4">
                  <button type="submit" name="caspaySearch" class="btn btn-block btn-primary text-left">Search</button>
                </div>
              </div>
            </form>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">View Paid Payments</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <table id="paidPaymentList" class="table table-bordered table-striped">
                ...
                <?php
                if(isset($_SESSION['caspayid'])) {
                  $list = $frontofficer->getCasPayment($_SESSION['caspayid']);
                } else {
                  $list = null;
                }
                ?>
...
<script>
  $(function () {
    $("#paidPaymentList").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false
    }).buttons().container().appendTo('#paidPaymentList_wrapper .col-md-6:eq(0)');
  });
</script>
</body>
</html>
