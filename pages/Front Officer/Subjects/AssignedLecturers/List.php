...
<head>
  ...
  <title>Front Officer | Assigned Lecturer List</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Assigned Lecturer List</h1>
            <form id="searchclass" action="../../../../models/subject.php" method="POST">
              <div class="row mt-4">
                <div class="col-md-4">
                  <div class="form-group">
                      <input type="text" id="subjectid" name="subjectid" placeholder="Subject ID" style="width: 100%;">
                    </div>
                  </div>
                <div class="col-md-4">
                  <button type="submit" name="lecsubSearch" class="btn btn-block btn-primary text-left">Search</button>
                </div>
              </div>
            </form>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">View Assigned Lecturers</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <table id="assingedlecList" class="table table-bordered table-striped">
                ...
                <?php
                if(isset($_SESSION['lecsub'])) {
                  $list = $frontofficer->getAssignedLecturers($_SESSION['lecsub']);
                } else {
                  $list = null;
                }
                ?>
...
<script>
  $(function () {
    $("#assingedlecList").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false
    }).buttons().container().appendTo('#assingedlecList_wrapper .col-md-6:eq(0)');
  });
</script>
</body>
</html>
