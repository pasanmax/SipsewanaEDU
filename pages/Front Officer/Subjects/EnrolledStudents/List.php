...
<head>
  ...
  <title>Front Officer | Enrolled Student List</title>
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <form id="searchclass" action="../../../../models/subject.php" method="POST">
              <div class="row mt-4">
                ...
                <div class="col-md-4">
                  <button type="submit" name="stsubSearch" class="btn btn-block btn-primary text-left">Search</button>
                </div>
              </div>
            </form>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">View Enrolled Students</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <table id="enrollstuList" class="table table-bordered table-striped">
                ...
                <?php
                if(isset($_SESSION['stsub'])) {
                  $list = $frontofficer->getEnrolledStudents($_SESSION['stsub']);
                } else {
                  $list = null;
                }
                ?>
...
<script>
  $(function () {
    $("#enrollstuList").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false
    }).buttons().container().appendTo('#enrollstuList_wrapper .col-md-6:eq(0)');
  });
</script>
</body>
</html>
