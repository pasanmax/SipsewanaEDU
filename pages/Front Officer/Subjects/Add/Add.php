...
<head>
  ...
  <title>Front Officer | Add Subject</title>
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Subject Add Form</h3>
            ...
            <div class="card-body">
              <form id="registration" action="">
                ...
                <div class="form-group">
                  <label for="subjectfee">Subject Fee</label>
                  <input type="text" id="subjectfee" class="form-control">
                </div>
                <div class="form-group">
                  <label for="subjectmedium">Medium</label>
                  <select id="subjectmedium" class="form-control custom-select">
