...
<head>
  ...
  <title>Front Officer | Pending Lecturer Registrations</title>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-open">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="../PendingDirectorRegistrations/PendingRegistrations.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Pending Lecturer Registrations</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../Dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Pending Lecturer Registrations</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <?php $list = $frontofficer->getLecturerApprovals();?>
              <table id="pendingLecturer" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>ID</th>
                  <th>Name</th>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group btn-group-sm">
                      ...
                      <a href="../../../../models/frontofficer.php?delLecApproval=<?= $item['lecturer_id']?>" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i></a>
                    </div>
                  </td>
                </tr>
                <?php }}?>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Approve Lecturer</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <form id="lecturerapprove" action="../../../../models/frontofficer.php" method="POST">
                    <table width="500px" height="300px">
                      ...
                      <tr>
                        <div class="form-group">
                          <td><label for="lname">Lecturer Name : </label></td>
                          <td>
                    ...
                    <div class="modal-footer justify-content-between">
                      <button type="submit" name="approvelecturer" class="btn btn-success">Approve</button>
...
<script>
  $(function () {
    $("#pendingLecturer").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false
    }).buttons().container().appendTo('#pendingLecturer_wrapper .col-md-6:eq(0)');
  });
