...
<head>
  ...
  <title>Front Officer | Pending Student Registrations</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pending Student Registrations</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <?php $list = $frontofficer->getStudentApprovals();?>
              <table id="pendingStudent" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>ID</th>
                  <th>Name</th>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group btn-group-sm">
                      ...
                      <a href="../../../../models/frontofficer.php?delStuApproval=<?= $item['student_id']?>" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i></a>
                    </div>
                  </td>
                </tr>
                <?php }}?>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="studentapprove" action="../../../../models/frontofficer.php" method="POST">
                    ...
                    <div class="modal-footer justify-content-between">
                      <button type="submit" name="approvestudent" class="btn btn-success">Approve</button>
...
<script>
  $(function () {
    ...
    }).buttons().container().appendTo('#pendingStudent_wrapper .col-md-6:eq(0)');
  });
