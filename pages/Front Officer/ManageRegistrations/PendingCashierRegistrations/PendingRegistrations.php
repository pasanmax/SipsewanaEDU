...
<head>
  ...
  <title>Front Officer | Pending Cashier Registrations</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Pending Cashier Registrations</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../Dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Pending Cashier Registrations</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <?php $list = $frontofficer->getCashierApprovals();?>
              <table id="pendingCashier" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>ID</th>
                  <th>Name</th>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group btn-group-sm">
                      ...
                      <a href="../../../../models/frontofficer.php?delCasApproval=<?= $item['cashier_id']?>" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i></a>
                    </div>
                  </td>
                </tr>
                <?php }}?>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Approve Cashier</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <form id="directorcashier" action="../../../../models/frontofficer.php" method="POST">
                    <table width="500px" height="300px">
                      ...
                      <tr>
                        <div class="form-group">
                          <td><label for="cname">Cashier Name : </label></td>
                          <td>
                    ...
                    <div class="modal-footer justify-content-between">
                      <button type="submit" name="approvecashier" class="btn btn-success">Approve</button>
...
<script>
  $(function () {
    $("#pendingCashier").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false
    }).buttons().container().appendTo('#pendingCashier_wrapper .col-md-6:eq(0)');
  });
