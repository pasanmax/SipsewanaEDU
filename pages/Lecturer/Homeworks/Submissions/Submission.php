...
<head>
  ...
  <title>Lecturer | Homework Submissions</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Homework Submissions</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<script>
  ...
  $(function () {
    ...
    }).buttons().container().appendTo('#submissionList_wrapper .col-md-6:eq(0)');
  });
</script>
</body>
</html>
