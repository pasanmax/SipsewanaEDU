...
<head>
  ...
  <title>Lecturer | Register for a Subject</title>
        ...
        <div class="col-md-6">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <form id="registration" action="../../../models/lecturer.php" method="POST">
                <div class="form-group">
                  <label>Select a Subject</label>
                  <?php $list = $subject->getRegSubNameLec($_SESSION['id'])?>
                  <select name="subname" class="form-control select2" style="width: 100%;" required>
                ...
                <div class="card-footer">
                  <button type="submit" name="Lregsub" class="btn btn-info">Register</button>
          ...
          <div class="card card-success">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-4">
                  <?php $list2 = $subject->getLRegFee($_SESSION['id'])?>
